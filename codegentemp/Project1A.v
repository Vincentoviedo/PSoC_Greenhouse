// ======================================================================
// Project1A.v generated from TopDesign.cysch
// 04/06/2022 at 05:00
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6ee6d428-ccc9-48fc-b306-8df8382dff93/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("d74cc7b9-7c80-4cff-bbd0-9fc08b624d10/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__PRes_net;
	wire [0:0] tmpFB_0__PRes_net;
	wire [0:0] tmpIO_0__PRes_net;
	wire [0:0] tmpINTERRUPT_0__PRes_net;
	electrical [0:0] tmpSIOVREF__PRes_net;
	...
	cy_psoc3_pins_v1_10
		...
		PRes
		 (.oe(tmpOE__PRes_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PRes_net[0:0]}),
		  .analog({Net_925}),
		  .io({tmpIO_0__PRes_net[0:0]}),
		  .siovref(tmpSIOVREF__PRes_net),
		  .interrupt({tmpINTERRUPT_0__PRes_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PRes_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__inTemp_net;
	wire [0:0] tmpFB_0__inTemp_net;
	wire [0:0] tmpIO_0__inTemp_net;
	wire [0:0] tmpINTERRUPT_0__inTemp_net;
	electrical [0:0] tmpSIOVREF__inTemp_net;

	cy_psoc3_pins_v1_10
		#(.id("6a7bcacf-2168-42b6-9a41-a50202608471"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		inTemp
		 (.oe(tmpOE__inTemp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__inTemp_net[0:0]}),
		  .analog({Net_926}),
		  .io({tmpIO_0__inTemp_net[0:0]}),
		  .siovref(tmpSIOVREF__inTemp_net),
		  .interrupt({tmpINTERRUPT_0__inTemp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__inTemp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__outTemp_net;
	wire [0:0] tmpFB_0__outTemp_net;
	wire [0:0] tmpIO_0__outTemp_net;
	wire [0:0] tmpINTERRUPT_0__outTemp_net;
	electrical [0:0] tmpSIOVREF__outTemp_net;

	cy_psoc3_pins_v1_10
		#(.id("67299524-04c6-4cd8-858f-1e3f9fcc5d04"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		outTemp
		 (.oe(tmpOE__outTemp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__outTemp_net[0:0]}),
		  .analog({Net_927}),
		  .io({tmpIO_0__outTemp_net[0:0]}),
		  .siovref(tmpSIOVREF__outTemp_net),
		  .interrupt({tmpINTERRUPT_0__outTemp_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__outTemp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5500494b-d0ba-48d1-b742-61635832c7c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("26836a91-94c8-4e0c-bcb1-bf7143eaf80e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__UVLight_net;
	wire [0:0] tmpFB_0__UVLight_net;
	wire [0:0] tmpIO_0__UVLight_net;
	wire [0:0] tmpINTERRUPT_0__UVLight_net;
	electrical [0:0] tmpSIOVREF__UVLight_net;

	cy_psoc3_pins_v1_10
		#(.id("1dd91f78-6109-49d0-9508-7784d504c60a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UVLight
		 (.oe(tmpOE__UVLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UVLight_net[0:0]}),
		  .io({tmpIO_0__UVLight_net[0:0]}),
		  .siovref(tmpSIOVREF__UVLight_net),
		  .interrupt({tmpINTERRUPT_0__UVLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UVLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1466caa9-ba2f-4bc7-bcba-c90d08c1d466"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__HeatPad_net;
	wire [0:0] tmpFB_0__HeatPad_net;
	wire [0:0] tmpIO_0__HeatPad_net;
	wire [0:0] tmpINTERRUPT_0__HeatPad_net;
	electrical [0:0] tmpSIOVREF__HeatPad_net;

	cy_psoc3_pins_v1_10
		#(.id("b8578688-1653-4bc0-97ff-64b704b36aeb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HeatPad
		 (.oe(tmpOE__HeatPad_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HeatPad_net[0:0]}),
		  .io({tmpIO_0__HeatPad_net[0:0]}),
		  .siovref(tmpSIOVREF__HeatPad_net),
		  .interrupt({tmpINTERRUPT_0__HeatPad_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HeatPad_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_3 UART (
        ...
        .rx_clk(Net_363),
        .rx_data(Net_364),
        .rx_interrupt(Net_365),
        .tx(Net_366),
        .tx_clk(Net_367),
        .tx_data(Net_368),
        .tx_en(Net_369),
        .tx_interrupt(Net_370));
